...
public class Gravel extends Block
{
	public Gravel()
	{
		...
		this.tex_coords[0] = new Vector2i(12, 0);
		this.tex_coords[1] = new Vector2i(12, 0);
		this.tex_coords[2] = new Vector2i(12, 0);
		this.tex_coords[3] = new Vector2i(12, 0);
		this.tex_coords[4] = new Vector2i(12, 0);
		this.tex_coords[5] = new Vector2i(12, 0);
