...
public class Pink_Wool extends Block
{
	public Pink_Wool()
	{
		this.id = 35;
		...
		this.tex_coords[0] = new Vector2i(10, 2);
		this.tex_coords[1] = new Vector2i(10, 2);
		this.tex_coords[2] = new Vector2i(10, 2);
		this.tex_coords[3] = new Vector2i(10, 2);
		this.tex_coords[4] = new Vector2i(10, 2);
		this.tex_coords[5] = new Vector2i(10, 2);
