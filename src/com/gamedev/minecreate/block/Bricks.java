...
public class Bricks extends Block
{
	public Bricks()
	{
		...
		this.tex_coords[0] = new Vector2i(4, 1);
		this.tex_coords[1] = new Vector2i(4, 1);
		this.tex_coords[2] = new Vector2i(4, 1);
		this.tex_coords[3] = new Vector2i(4, 1);
		this.tex_coords[4] = new Vector2i(4, 1);
		this.tex_coords[5] = new Vector2i(4, 1);
