...
public class AmanitaMuscaria extends Block
{
	public AmanitaMuscaria()
	{
		this.id = 41;
		
		this.tex_coords = new Vector2i[6];
		this.tex_coords[0] = new Vector2i(5, 3);
		this.tex_coords[1] = new Vector2i(5, 3);
		this.tex_coords[2] = new Vector2i(5, 3);
		this.tex_coords[3] = new Vector2i(5, 3);
		this.tex_coords[4] = new Vector2i(5, 3);
		this.tex_coords[5] = new Vector2i(5, 3);
