...
public class Wood extends Block
{
	public Wood()
	{
		...
		this.tex_coords[0] = new Vector2i(9, 0);
		this.tex_coords[1] = new Vector2i(9, 0);
		this.tex_coords[2] = new Vector2i(8, 0);
		this.tex_coords[3] = new Vector2i(8, 0);
		this.tex_coords[4] = new Vector2i(8, 0);
		this.tex_coords[5] = new Vector2i(8, 0);
