...
public class Gold_Ore extends Block
{
	public Gold_Ore()
	{
		...
		this.tex_coords[0] = new Vector2i(2, 1);
		this.tex_coords[1] = new Vector2i(2, 1);
		this.tex_coords[2] = new Vector2i(2, 1);
		this.tex_coords[3] = new Vector2i(2, 1);
		this.tex_coords[4] = new Vector2i(2, 1);
		this.tex_coords[5] = new Vector2i(2, 1);
