...
public class Gray_Wool extends Block
{
	public Gray_Wool()
	{
		this.id = 26;
		...
		this.tex_coords[0] = new Vector2i(1, 2);
		this.tex_coords[1] = new Vector2i(1, 2);
		this.tex_coords[2] = new Vector2i(1, 2);
		this.tex_coords[3] = new Vector2i(1, 2);
		this.tex_coords[4] = new Vector2i(1, 2);
		this.tex_coords[5] = new Vector2i(1, 2);
