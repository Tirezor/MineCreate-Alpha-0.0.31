...
public class Orange_Wool extends Block
{
	public Orange_Wool()
	{
		this.id = 32;
		...
		this.tex_coords[0] = new Vector2i(7, 2);
		this.tex_coords[1] = new Vector2i(7, 2);
		this.tex_coords[2] = new Vector2i(7, 2);
		this.tex_coords[3] = new Vector2i(7, 2);
		this.tex_coords[4] = new Vector2i(7, 2);
		this.tex_coords[5] = new Vector2i(7, 2);
