...
public class Purple_Wool extends Block
{
	public Purple_Wool()
	{
		this.id = 34;
		...
		this.tex_coords[0] = new Vector2i(9, 2);
		this.tex_coords[1] = new Vector2i(9, 2);
		this.tex_coords[2] = new Vector2i(9, 2);
		this.tex_coords[3] = new Vector2i(9, 2);
		this.tex_coords[4] = new Vector2i(9, 2);
		this.tex_coords[5] = new Vector2i(9, 2);
