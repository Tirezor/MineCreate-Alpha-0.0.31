...
public class Grass extends Block
{
	public Grass()
	{
		...
		this.tex_coords[0] = new Vector2i(1, 0);
		this.tex_coords[1] = new Vector2i(3, 0);
		this.tex_coords[2] = new Vector2i(2, 0);
		this.tex_coords[3] = new Vector2i(2, 0);
		this.tex_coords[4] = new Vector2i(2, 0);
		this.tex_coords[5] = new Vector2i(2, 0);
