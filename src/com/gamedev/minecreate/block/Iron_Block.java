...
public class Iron_Block extends Block
{
	public Iron_Block()
	{
		this.id = 36;
		...
		this.tex_coords[0] = new Vector2i(9, 1);
		this.tex_coords[1] = new Vector2i(9, 1);
		this.tex_coords[2] = new Vector2i(9, 1);
		this.tex_coords[3] = new Vector2i(9, 1);
		this.tex_coords[4] = new Vector2i(9, 1);
		this.tex_coords[5] = new Vector2i(9, 1);
