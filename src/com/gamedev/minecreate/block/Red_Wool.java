...
public class Red_Wool extends Block
{
	public Red_Wool()
	{
		this.id = 28;
		...
		this.tex_coords[0] = new Vector2i(3, 2);
		this.tex_coords[1] = new Vector2i(3, 2);
		this.tex_coords[2] = new Vector2i(3, 2);
		this.tex_coords[3] = new Vector2i(3, 2);
		this.tex_coords[4] = new Vector2i(3, 2);
		this.tex_coords[5] = new Vector2i(3, 2);
